...
RouteModel::Node *RoutePlanner::NextNode() {
	std::sort(open_list.begin(), open_list.end(), [](const auto &comp_first, const auto &comp_sec){ 
    return comp_first->h_value + comp_first->g_value < comp_sec->h_value + comp_sec->g_value;}
  	);

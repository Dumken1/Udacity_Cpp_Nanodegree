...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
    ...
    ChatBot instchatbot("../images/chatbot.png");
    instchatbot.SetChatLogicHandle(this);

    
     instchatbot.SetRootNode(rootNode);
     rootNode->MoveChatbotHere(std::move(instchatbot));
